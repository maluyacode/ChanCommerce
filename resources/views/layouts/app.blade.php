...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-red navbar-dark"style="background-color:#A52A2A ">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false" style="color: white; text-align:right">
    ...
    <aside class="main-sidebar "style="background-color: #F0E68C>>
        ...
        <a href="/" class="brand-link">
            <img src="/images/SQUARELOGO.png" alt=""width="40px" height="40px"
                 class="img" 
                 style="opacity: .8" >
    ...
    <footer class="main-footer"style="background-color: #A52A2A">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2023 <a style="color: white" href="">CQ Hardware Store </a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
