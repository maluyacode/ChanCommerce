...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased" style="background-color: #F0E68C">
        <div class="">
            ...
            <a class="font-semibold text-black-600 hover:text-dark-900 dark:text-dark-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" href="{{ url('/') }}">
                {{'QK Hardware Store' }}
        ...
        @endif
            @endauth
                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        <a href="{{ url('redirect') }}" class="font-semibold text-black-600 hover:text-dark-900 dark:text-dark-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" >Home</a>
                    @else
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <img src="/images/SQUARELOGO.png" alt=""width="80px" height="80px"
                 class="img" 
                 style="opacity: .8" >
                </div>
                ...
                <nav class="navbar navbar-expand-md navbar-dark navbar-laravel">
                    <div class="container" style =  "background-color: #A52A2A">
                        ...
                        <li class= "collapse navbar-collapse" id="navbarSupportedContent" href="{{ url('/') }}" style ="justify-content: space-between">
                          
                            
                            @foreach ($categories as $category)
                               
                            <a class="btn btn" style="background-color:#000; color:#e5e7eb" href="{{route('category', $category->id)}}">{{$category->cat_name}} </a>
                                            ...
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                  ...
                                                  <p class="card-text">{{ $item->description }}</p>
                                                   <div class="clearfix">
                                                    <form id="my-form" method="POST" action="{{ route('addcart', ['id' => $item->id]) }}">
                                                        @csrf
