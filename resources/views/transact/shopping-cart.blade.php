...
@if(Auth::id())
    <div class="content">
            ...
            <div class="row">
                <div class="col-lg-12" >
                    ...
                    <tr>
                            ...
                            <td><img src="{{asset($carts->img_path)}}" alt="" width="80px" height="80px" style="border:3px solid #000000; padding:3px; margin:2px"></td>
                            <td><strong><span style="font-size: 17px; justify-content: center">{{ $carts->item_name }}</span></strong></td>
                            <td><span class="badge badge-primary rounded-pill" style="font-size: 17px">{{ $carts->quantityC }}</span></td>
                            
                            <td><span class="label label-success" style="font-size: 17px;">{{ $carts->sellprice }}</span></td>  
                            <td class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('increment', ['id' => $carts->item_id]) }}">Add Quantity
                                            </a></li>
                                    <li><a href="{{ route('decrement', ['id' => $carts->item_id]) }}">Reduce Quantity</a></li>
                                    <li><a href="{{ route('delete', ['id' => $carts->item_id]) }}">Reduce All</a></li>
                                </ul>
                            </td>                 
                        </tr>
                    @endforeach
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-2 text-center" style = "background-color: white; border:3px solid #000000; font-size: 18px " >
                <br>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3 text-right" style="font-size: 20px" >
                    <button type="submit" class="btn btn-success" id="checkout-button" style="border:3px solid #000000; padding:3px; margin:2px">Checkout</button>
                </div>
