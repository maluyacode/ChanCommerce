        ...
        render: function (data) {
            if (data.status === "Processing") {
                return `<button type="button" data-id="${data.id}" class="btn btn-primary shipped">
                    ...
                    <button type="button" disabled data-id="${data.id}" class="btn btn-success btn-delete delivered">
                        <i class="bi bi-wallet-fill" style="color:white"></i> Delivered
                    </button>`;
            } else {
                return `<button type="button" disabled data-id="${data.id}" class="btn btn-primary shipped">
                <i class="bi bi-truck"></i> Shipped
                    </button>
                    <button type="button"  data-id="${data.id}" class="btn btn-success btn-delete delivered">
                        <i class="bi bi-wallet-fill" style="color:white"></i> Delivered
                    </button>`;
            }
